...
public class TestList {
  ...
  public void testSizeNonEmpty() {
    // Fixed expected values in the assertions below
    list.add(77);
  ...
  public void testContains() {
    ...
    // Before adding 77 to the list
    assertEquals(false, list.contains(77));

    // After adding 77 to the list
    list.add(77);
  ...
  public void testAddMultiple() {
    ...
    list.add(77);
    list.add(77);
    // Expected values in the assertions below
  ...
  public void testRemoveObject() {
    ...
    assertEquals(77, list.get(3).intValue());
    list.remove(Integer.valueOf(5)); // This removes 66 from the list (the value at index 5).
  ...
  public void testAddAll() {
    ...
    // added items to the list to make the following assertions pass
  ...
  public void testRemoveAll() {
    ...
    // removed items from the list to make the following assertions pass
    // (without touching the assertions themselves)
  ...
  public void testRetainAll() {
    ...
    // removed items from the list to making the following assertions pass
    // (without touching the assertions themselves)
  ...
  public void testSet() {
    ...
    list.add(77);
    list.add(66);
    // using the set method to change specific elements in the list
